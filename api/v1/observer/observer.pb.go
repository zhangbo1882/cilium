...
func (x *GetFlowsResponse) GetDebugEvent() *flow.DebugEvent {
	if x, ok := x.GetResponseTypes().(*GetFlowsResponse_DebugEvent); ok {
		return x.DebugEvent
	}
	return nil
}
...
type GetFlowsResponse_DebugEvent struct {
...
func (*GetFlowsResponse_DebugEvent) isGetFlowsResponse_ResponseTypes() {}
...
var file_observer_observer_proto_rawDesc = []byte{
	...
	0x02, 0x10, 0x03, 0x22, 0xee, 0x02, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x46, 0x6c, 0x6f, 0x77, 0x73,
	...
	0x73, 0x22, 0x8d, 0x02, 0x0a, 0x04, 0x4e, 0x6f, 0x64, 0x65, 0x12, 0x12, 0x0a, 0x04, 0x6e, 0x61,
	...
	,
...
var file_observer_observer_proto_goTypes = []interface{}{
	...
	(*flow.DebugEvent)(nil),        // 15: flow.DebugEvent
	(relay.NodeState)(0),           // 16: relay.NodeState
}
var file_observer_observer_proto_depIdxs = []int32{
	...
	15, // 10: observer.GetFlowsResponse.debug_event:type_name -> flow.DebugEvent
	10, // 11: observer.GetFlowsResponse.time:type_name -> google.protobuf.Timestamp
	6,  // 12: observer.GetNodesResponse.nodes:type_name -> observer.Node
	16, // 13: observer.Node.state:type_name -> relay.NodeState
	7,  // 14: observer.Node.tls:type_name -> observer.TLS
	2,  // 15: observer.Observer.GetFlows:input_type -> observer.GetFlowsRequest
	4,  // 16: observer.Observer.GetNodes:input_type -> observer.GetNodesRequest
	0,  // 17: observer.Observer.ServerStatus:input_type -> observer.ServerStatusRequest
	3,  // 18: observer.Observer.GetFlows:output_type -> observer.GetFlowsResponse
	5,  // 19: observer.Observer.GetNodes:output_type -> observer.GetNodesResponse
	1,  // 20: observer.Observer.ServerStatus:output_type -> observer.ServerStatusResponse
...
func file_observer_observer_proto_init() {
	...
	file_observer_observer_proto_msgTypes[3].OneofWrappers = []interface{}{
		...
		(*GetFlowsResponse_DebugEvent)(nil),
	}
	type x struct{}
