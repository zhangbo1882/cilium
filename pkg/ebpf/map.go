...
func (m *Map) OpenOrCreate() error {
	...
	// The map's spec is not guaranteed to be defined if for example the map
	// is created from a FD or ID.
	if m.spec == nil {
		return fmt.Errorf("unable to create map: map's spec is nil")
	}
