...
func NewMaglevInnerMap(name string, tableSize uint64) (*maglevInnerMap, *ebpf.MapSpec, error) {
	spec := &ebpf.MapSpec{
		Name:       name,
		Type:       ebpf.Array,
...
// identified by an ID.
func MaglevInnerMapFromID(id int, tableSize uint64) (*maglevInnerMap, error) {
