...
pipeline {
    ...
    environment {
        ...
        BASE_IMAGE="""${sh(
                returnStdout: true,
                script: 'if [ "${run_with_race_detection}" = "" ]; then echo -n "scratch"; else echo -n "quay.io/cilium/cilium-runtime:2021-01-29-dontuse@sha256:ccc76393cb4af45a6d573f36f2b613312f8f66e6b23b4243c2e16ab63d073ab3"; fi'
            )}"""
    }
